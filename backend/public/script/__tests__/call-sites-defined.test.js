...
const GLOBALS = new Set([
  ...
  'WeakMap', 'WeakSet', 'parseFloat', 'parseInt', 'isNaN', 'isFinite',
  ...
  'localStorage', 'sessionStorage', 'fetch', 'alert', 'confirm',
  'prompt', 'console', 'event', 'self', 'frames', 'parent', 'top',
  'opener', 'screen', 'crypto', 'performance', 'URL', 'URLSearchParams',
  'FormData', 'Headers', 'Request', 'Response', 'Blob', 'File',
  'FileReader', 'FileList', 'AbortController', 'AbortSignal',
  'CustomEvent', 'Event', 'MutationObserver', 'IntersectionObserver',
  'ResizeObserver', 'Image', 'Audio', 'HTMLElement', 'HTMLDivElement',
  'HTMLInputElement', 'HTMLButtonElement', 'HTMLFormElement',
  'HTMLSelectElement', 'HTMLTextAreaElement', 'HTMLAnchorElement',
  'HTMLOptionElement', 'HTMLLabelElement', 'Element', 'Node',
  'NodeList', 'Text', 'DocumentFragment', 'DOMParser', 'XMLHttpRequest',
  'getComputedStyle', 'matchMedia', 'scrollTo', 'scrollBy', 'print',
  'stopPropagation', 'preventDefault', 'EventSource',
  // Spezielle Shortcuts, die das Projekt selbst definiert
  'sb',
  // Konstanten, die ohnehin injected werden
  'ICON_TRASH', 'ICON_EDIT', 'ICON_PLUS',
