...
describe('DTO: startedAt (Etappe B.8)', () => {
  it('startedAt ist null für draft', () => {
    const v = prepareTournamentView({
      id: 't-1', groupId: 'g-1', name: 'T', mode: 'groups_ko', status: 'draft',
      createdById: 'u-1', createdAt: new Date(), updatedAt: new Date(),
    });
  ...
  it('startedAt ist null für "generated" ohne Start', () => {
    const v = prepareTournamentView({
      id: 't-1', groupId: 'g-1', name: 'T', mode: 'groups_ko', status: 'generated',
      startedAt: null, createdById: 'u-1', createdAt: new Date(), updatedAt: new Date(),
    });
    expect(v.startedAt).toBeNull();
  });
  ...
  it('startedAt ist Date-Objekt für gestartete Turniere', () => {
    ...
    const v = prepareTournamentView({
      id: 't-1', groupId: 'g-1', name: 'T', mode: 'groups_ko', status: 'group_stage',
      startedAt: at, createdById: 'u-1', createdAt: new Date(), updatedAt: new Date(),
    });
