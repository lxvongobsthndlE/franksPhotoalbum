...
export function createMockPrismaClient(overrides = {}) {
  const prisma = {
    ...
    accountDeletionRequest: {
      ...
      upsert: vi.fn(),
      delete: vi.fn(),
      ...overrides.accountDeletionRequest,
    },
    adminActionLog: {
      findUnique: vi.fn(),
      findMany: vi.fn(),
      create: vi.fn(),
      ...overrides.adminActionLog,
    },
    blockedLoginIdentity: {
      findUnique: vi.fn(),
      findMany: vi.fn(),
      upsert: vi.fn(),
      create: vi.fn(),
    ...
    groupFeedComment: {
      ...
      delete: vi.fn(),
      deleteMany: vi.fn(),
      ...overrides.groupFeedComment,
    },
    groupFeedCommentHistory: {
      findMany: vi.fn(),
      create: vi.fn(),
      ...overrides.groupFeedCommentHistory,
    },
    groupFeedCommentLike: {
      findUnique: vi.fn(),
      findMany: vi.fn(),
      create: vi.fn(),
      count: vi.fn(),
      upsert: vi.fn(),
      deleteMany: vi.fn(),
      ...overrides.groupFeedCommentLike,
    },
    tournamentPreset: {
      findUnique: vi.fn(),
      findMany: vi.fn(),
    ...
    tournamentPresetStage: {
      ...
      createMany: vi.fn(),
      deleteMany: vi.fn(),
      ...overrides.tournamentPresetStage,
    },
    tournamentInstance: {
      findUnique: vi.fn(),
      findMany: vi.fn(),
    ...
    tournamentGroupMembership: {
      ...
      delete: vi.fn(),
      deleteMany: vi.fn(),
      ...overrides.tournamentGroupMembership,
    },
    tournamentTeam: {
      findUnique: vi.fn(),
      findMany: vi.fn(),
    ...
    tournamentParticipant: {
      ...
      delete: vi.fn(),
      deleteMany: vi.fn(),
      ...overrides.tournamentParticipant,
    },
    tournamentRound: {
      findUnique: vi.fn(),
      findMany: vi.fn(),
    ...
    tournamentMatchResult: {
      ...
      delete: vi.fn(),
      deleteMany: vi.fn(),
      ...overrides.tournamentMatchResult,
    },
    $transaction: vi.fn(),
    ...overrides,
  };
