...
export default async function notificationsRoutes(fastify) {
  ...
  fastify.put('/preferences', async (request, reply) => {
    ...
    const allowed = [
      'inApp_deputyAdded',
      'inApp_deputyRemoved',
      'inApp_contributorAdded',
      'inApp_contributorRemoved',
      'inApp_groupMemberJoined',
      'inApp_groupMemberLeft',
      'inApp_groupDeleted',
      'inApp_photoLiked',
      'inApp_photoCommented',
      'inApp_feedPostLiked',
      'inApp_feedPostCommented',
      'inApp_feedCommentMentioned',
      'inApp_feedCommentReplied',
      'inApp_feedCommentLiked',
      'inApp_newPhoto',
      'inApp_newAlbum',
      'email_deputyAdded',
      'email_deputyRemoved',
      'email_contributorAdded',
      'email_contributorRemoved',
      'email_groupMemberJoined',
      'email_groupMemberLeft',
      'email_groupDeleted',
      'email_photoLiked',
      'email_photoCommented',
      'email_feedPostLiked',
      'email_feedPostCommented',
      'email_feedCommentMentioned',
      'email_feedCommentReplied',
      'email_feedCommentLiked',
      'email_newPhoto',
      'email_newAlbum',
      'email_system',
    ];
